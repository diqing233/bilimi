...
describe('renderer porcelain theme styles', () => {
  ...
  it('styles the old favorites guide as a step-based review flow', () => {
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-videos { grid-column: 1 / -1; display: flex; align-items: stretch; gap: 12px; min-width: 0; overflow-x: auto;')
    expectStyleSnippet('padding: 0 6px 6px; scroll-padding-inline: 6px;')
    expectStyleSnippet('.favorite-ledger-panel__preview-videos article { flex: 0 0 min(calc(100% - 34px), 320px); min-width: 0; display: grid; grid-template-rows: minmax(116px, 1fr) auto;')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-delta-row { min-width: 0; display: grid; grid-template-columns: minmax(0, 1fr) auto;')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-delta-action { min-width: 0; min-height: 24px; padding: 2px 6px;')

...
describe('renderer porcelain theme styles', () => {
  ...
  it('styles the old favorites guide as a step-based review flow', () => {
    ...
    expectStyleSnippet('.favorite-ledger-panel__deepseek-archive-scope { display: grid; grid-template-columns: auto minmax(0, 1fr);')
    expectStyleSnippet('.favorite-ledger-panel__deepseek-archive-scope select { width: 100%; max-width: 100%;')
    expectStyleSnippet('.favorite-ledger-panel__preview-videos { grid-column: 1 / -1; display: grid; grid-template-columns: minmax(0, 1fr);')
    expectStyleSnippet('.favorite-ledger-panel__preview-videos article { min-width: 0; display: grid; grid-template-rows: minmax(116px, 1fr) auto;')
    expectStyleSnippet('.favorite-ledger-panel__preview-videos article + article { border-top: 1px dashed rgba(31, 99, 181, 0.2); padding-top: 8px;')

...
describe('renderer porcelain theme styles', () => {
  ...
  it('styles the old favorites guide as a step-based review flow', () => {
    ...
    expectStyleSnippet('.favorite-ledger-panel__archive-history-actions { display: flex; flex-wrap: wrap; gap: 8px;')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-videos article { min-width: 0; border: 0; background: transparent; padding: 0;')
    expectStyleSnippet('.favorite-ledger-panel__preview-video { width: 100%; min-height: 0; display: grid; align-content: start;')
    expectStyleSnippet('border: 1px solid rgba(31, 99, 181, 0.16); border-left: 3px solid rgba(31, 99, 181, 0.16); background: rgba(255, 255, 255, 0.72);')
    expectStyleSnippet('.favorite-ledger-panel__preview-video[data-selected="true"] { border-color: rgba(31, 99, 181, 0.22); border-left-color: rgba(31, 99, 181, 0.58); background: rgba(220, 238, 255, 0.5);')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-row--pending .favorite-ledger-panel__preview-video { border-color: rgba(31, 99, 181, 0.14); border-left-color: rgba(31, 99, 181, 0.14); background: rgba(247, 251, 255, 0.6);')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-delta-row { display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: 6px; align-items: center; min-width: 0; border-left: 2px solid rgba(211, 119, 35, 0.74); background: rgba(255, 246, 232, 0.88);')

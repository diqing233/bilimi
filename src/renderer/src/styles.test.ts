...
describe('renderer porcelain theme styles', () => {
  ...
  it('styles the old favorites guide as a step-based review flow', () => {
    ...
    expectStyleSnippet('.favorite-ledger-panel__guide-hint { margin: 0; border: 1px solid rgba(31, 99, 181, 0.14);')
    ...
    expectStyleSnippet('.favorite-ledger-panel__deepseek-archive-heading, .favorite-ledger-panel__deepseek-archive-scope { display: grid; grid-template-columns: minmax(0, 1fr) auto;')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-delta { color: var(--porcelain-primary); font-weight: 700;')
    expectStyleSnippet('.favorite-ledger-panel__preview-row--pending { border-color: rgba(31, 99, 181, 0.55); background: rgba(220, 238, 255, 0.34);')

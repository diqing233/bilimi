...
describe('renderer porcelain theme styles', () => {
  ...
  it('styles the old favorites guide as a step-based review flow', () => {
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-groups { display: grid; gap: 10px; max-height: min(62vh, 720px); overflow-y: auto; min-width: 0; border: 1px solid rgba(31, 99, 181, 0.22);')
    expectStyleSnippet('.favorite-ledger-panel__preview-row { display: grid; grid-template-columns: minmax(0, 1fr); gap: 8px; align-items: start; min-width: 0; border: 1px solid rgba(31, 99, 181, 0.18);')
    expectStyleSnippet('.favorite-ledger-panel__preview-row header { grid-column: 1 / -1; position: sticky; top: 0; z-index: 2;')
    ...
    expectStyleSnippet('.favorite-ledger-panel__deepseek-archive-scope > button { min-width: 72px;')
    expectStyleSnippet('.favorite-ledger-panel__deepseek-archive-scope-menu { position: absolute; z-index: 10;')
    expectStyleSnippet('.favorite-ledger-panel__preview-videos { grid-column: 1 / -1; display: flex; align-items: stretch; gap: 8px; min-width: 0; overflow-x: auto;')
    expectStyleSnippet('.favorite-ledger-panel__preview-videos article { flex: 0 0 min(82%, 320px); min-width: 0; display: grid; grid-template-rows: minmax(116px, 1fr) auto;')
    expectStyleSnippet('.favorite-ledger-panel__preview-videos article + article { border-left: 1px dashed rgba(31, 99, 181, 0.2); padding-left: 8px;')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-video[data-selected="true"] { border-color: rgba(31, 99, 181, 0.22); border-right-color: rgba(31, 99, 181, 0.58); background: rgba(220, 238, 255, 0.5);')

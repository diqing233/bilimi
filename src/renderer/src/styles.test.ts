...
describe('renderer porcelain theme styles', () => {
  ...
  it('styles the old favorites guide as a step-based review flow', () => {
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-videos article { flex: 0 0 calc(100% - 28px); min-width: 0; display: grid; grid-template-rows: minmax(116px, 1fr) auto;')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-delta-row { min-width: 0; display: block; border-radius: var(--porcelain-radius-control);')

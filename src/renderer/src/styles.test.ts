...
describe('renderer porcelain theme styles', () => {
  ...
  it('styles the old favorites guide as a step-based review flow', () => {
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-row { display: grid; grid-template-columns: minmax(150px, 28%) minmax(0, 1fr);')
    expectStyleSnippet('.favorite-ledger-panel__preview-videos { display: grid; grid-auto-columns: minmax(180px, 36%); grid-auto-flow: column; gap: 8px; min-width: 0; overflow-x: auto;')

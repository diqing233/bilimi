...
describe('renderer porcelain theme styles', () => {
  ...
  it('styles the old favorites guide as a step-based review flow', () => {
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-row header { position: sticky; top: 0; z-index: 2;')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-videos { grid-column: 1 / -1; display: flex; align-items: stretch; gap: 8px; overflow-x: auto;')

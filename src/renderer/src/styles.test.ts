...
describe('renderer porcelain theme styles', () => {
  ...
  it('styles the old favorites guide as a step-based review flow', () => {
    ...
    expectStyleSnippet('.favorite-ledger-panel__candidate-list { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr));')
    ...
    expectStyleSnippet('.favorite-ledger-panel__candidates article { min-width: 0; padding: 6px;')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-row { display: grid; grid-template-columns: minmax(160px, max-content) minmax(0, 1fr);')
    expectStyleSnippet('.favorite-ledger-panel__preview-row header { grid-column: 1;')
    expectStyleSnippet('.favorite-ledger-panel__preview-heading { display: inline-flex; align-items: baseline; gap: 8px;')
    ...
    expectStyleSnippet('.favorite-ledger-panel__preview-video-title { display: block; min-width: 0; color: var(--porcelain-deep); font-size: 13px; font-weight: 400;')

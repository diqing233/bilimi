...
describe('renderer porcelain theme styles', () => {
  ...
  it('keeps favorite ledger status near the toolbar and ledger copy compact', () => {
    ...
    expectStyleSnippet('.favorite-ledger-panel__chip-item[data-drop-position="before"]::before, .favorite-ledger-panel__chip-item[data-drop-position="after"]::after { position: absolute;')
    expectStyleSnippet('.favorite-ledger-panel__chip-item[data-drop-position="before"]::before { top: -4px;')
    expectStyleSnippet('.favorite-ledger-panel__chip-item[data-drop-position="after"]::after { bottom: -4px;')

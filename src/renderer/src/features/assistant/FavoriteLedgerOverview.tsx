...
const LEDGER_SYNC_HINTS = [
  ...
  { title: '删除 bilimi 收藏夹：', detail: '点击右侧“×”进入删除模式，勾选要删除的收藏夹后点击“删除”。默认仅从 bilimi 删除并保留 B 站收藏夹；只有明确选择“同时从 B 站删除收藏夹及其中分类视频”时，才会删除对应的 B 站 bilimi 收藏夹。原有普通 B 站收藏夹不受影响。' },

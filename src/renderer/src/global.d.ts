...
type BilimiDesktopApi = {
  ...
  deleteFavoriteLibraryManagedFolderLocalGroup?: (accountMid: string, folderIds: string[]) => Promise<unknown>
  clearFavoriteLibraryManagedFolderRecords?: (accountMid: string, folderIds: string[]) => Promise<unknown>

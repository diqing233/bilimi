...
- [x] Add tests that expect 小mi state labels/bubbles, decorative pet images on the floating seal, sidebar collapse button, top workspace tabs, and review actions.
...
- [x] Update state labels and bubbles to 小mi persona copy.
